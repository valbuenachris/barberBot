<?php
    ...
    function menuBarberosCabral($pdo, $from) {
            ...
            try{
                    ...
                    $body = array(
                        ...
                        "receiver" => "$from",
                        "data" => array(
                            "url" => "http://bot.tienderu.com/app/storage?url=1/matibanus.jpeg",
                            "media_type" => "image",
                            "caption" => "*2. MATI BANUS* \n💇🏻‍♂️ Especialidad: Cortes Modernos y peinados de tendencia. \n🕒 Experiencia: Más de 4 años en la industria de la barbería."
                        )
                    );
                    ...
                    update_status($pdo, $from, 'barbero');
